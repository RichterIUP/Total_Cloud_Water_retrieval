...
def calc_avk(t_matrix):
    ...
    #tcwret_io.write(averaging_kernel)
...
def iteration(lm_param, t_matrix):
    ...
    D = S_A_INV_MATRIX
    left_side = np.add(np.add(JT_W_J, S_A_INV_MATRIX), lm_param**2*D)
    ...
    #tcwret_io.write("Post")
    #tcwret_io.write(T_new)
    #calc_avk(T_new)
